...
class _PesanPageState extends State<PesanPage> {
  ...
  Future<void> _loadItems() async {
    try {
      ...
      setState(() {
        _items = washItems;
        _quantities = {for (var item in _items) item.id ?? 0: 0};
        _isLoading = false;
      });
    } catch (_) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: const InputDecoration(hintText: 'Masukkan catatan seperti: warna merah, setrika rapi...'),
          maxLines: 2,
        ),
        actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Buat Order Laundry', style: TextStyle(fontWeight: FontWeight.bold)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Padding(
                        ...
                        child: Text(
                          'Pilih Layanan Laundry Kiloan / Satuan',
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              decoration: BoxDecoration(
                                color: Colors.white,
                                borderRadius: BorderRadius.circular(16),
                                border: Border.all(color: quantity > 0 ? primaryColor.withOpacity(0.3) : Colors.grey[200]!),
                              ),
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('Tarif: ${formatRp(item.harga)}', style: TextStyle(color: Colors.grey[600], fontSize: 12)),
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    ...
                                    IconButton(
                                      icon: Icon(Icons.add_circle_outline_rounded, color: primaryColor, size: 22),
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                children: _items
                                    ...
                                    .map((it) {
                                      ...
                                      return Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Text('$qty x ', style: TextStyle(fontWeight: FontWeight.bold, color: primaryColor)),
                                            Expanded(
                                              child: Text(
                                                it.nama,
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text('Total Item:', style: TextStyle(fontSize: 14, color: Colors.grey)),
                          Text('$totalItems pcs', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                        ],
                      ),
